...
public class CompositionLiteralBuilder extends SingleNodeVisitor implements IBuilder {
	...
	public CompositionLiteralBuilder(StabileAPI api) {
	...
	private String eval(Expression exp) {
		Expr expr = literalBuilder.getExpr(exp);
		
		if (!expr.isVariable()){
			return expr.longReps().get(0).getFirst();
	...
	public boolean visit(CompilationUnit node) {
		...
		this.literalBuilder = new LiteralBuilder(imported, stf, this.typeBuilder, params, locals);
		return true;
	}
