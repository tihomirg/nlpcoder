...
//		stat.read();
//
//		scorer = new ScorerPipeline(new RichDeclarationScorer[]{new HungarianScorer(), new UnigramScorer(0.5)});
//
...
//
//		this.search = new Search(scorer, listener, api, indexScoress, frequencies);
//	}
//
