...
public class InfixOperatorsClassInfo extends ClassInfo {
	
	private static final String SHORT_NAME = "Infix";
	...
	public InfixOperatorsClassInfo(){}
	
	public InfixOperatorsClassInfo(InitialTypeFactory tf) {
