...
public class RandomDeltaTuner {
	...
	public RandomDeltaTuner(int randomIterations, int upper, int isTextSolutionNumber, boolean print) {
		this.upper = upper;
	...
	public void tweak() {
		...
		RandomSingleValueReseter randomReseter = new RandomSingleValueReseter(generator);
	...
	private List<ParameterGenerator> getIndividualGenerators() {
		...
		generators.add(new DoubleGenerator("kindMatrix[0][1]", 0.75, 0.05, 0.0, 1.0) {
			@Override
			public void set() {
		...
		generators.add(new DoubleGenerator("kindMatrix[1][0]", 0.25, 0.05, 0.0, 1.0) {
			@Override
			public void set() {
				double[][] kindMatrix = SearchConfig.getDeclarationInputKindMatrix();
		...
		generators.add(new DoubleGenerator("kindMatrix[1][1]", 0.75, 0.05, 0.0, 1.0) {
			@Override
			public void set() {
				double[][] kindMatrix = SearchConfig.getDeclarationInputKindMatrix();
		...
		generators.add(new DoubleGenerator("declarationInputUnmatchingWeight", 0.02, 0.01, 0.0, 1.0) {
			@Override
			public void set() {
		...
		generators.add(new DoubleGenerator("declarationScorerCoefs", 0.2, 0.1, 0.0, 1.0) {
			@Override
			public void set() {
		...
		generators.add(new IntGenerator("PartialExpressionIndividualSize", 1, 1, 1, 3) {
			@Override
			public void set() {
		...
		generators.add(new DoubleGenerator("PartialExpressionBadMergePenalty", 0.9, 0.1, 0.5, 1.5) {
			@Override
			public void set() {
		...
		generators.add(new DoubleGenerator("PartialExpressionIndividualSizePenalty", 0.1, 0.1, 0.0, 1.0) {
			@Override
			public void set() {
		...
		generators.add(new DoubleGenerator("PartialExpressionMergeReward", 0.1, 0.1, 0.0, 1.0) {
			@Override
			public void set() {
		...
		generators.add(new DoubleGenerator("PartialExpressionMergeSizePenalty", 0.6, 0.1, 0.0, 1.5) {
			@Override
			public void set() {
		...
		generators.add(new DoubleGenerator("HoleWeight", 0.10, 0.1, 0.0, 1.0) {
			@Override
			public void set() {
		...
		generators.add(new DoubleGenerator("InputExprRepetitionPenalty", 0.9, 0.1, 0.5, 1.5) {
			@Override
			public void set() {
		...
		generators.add(new DoubleGenerator("InputExprWeight", 0.8, 0.1, 0.5, 1.5) {
			@Override
			public void set() {
	...
	public static void main(String[] args) {
		...
		RandomDeltaTuner tweaker = new RandomDeltaTuner(100, numOfSolutions-1, numOfSolutions, true);
